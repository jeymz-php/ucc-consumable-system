...
class AccountSettingsController extends Controller
{
    ...
    public function deactivate(Request $request)
    {
        ...
        ActivityLog::record(
            'deactivate', 'User',
            "User self-deactivated their account: {$user->email} [source: CS]",
            'user', $user->id
        );
        ...
        return redirect()->route('login')
            ->with('success', 'Your account has been deactivated. You can reactivate it anytime by logging in again.');
    }
    ...
    public function requestDeletion(Request $request)
    {
        ...
        ActivityLog::record(
            'request_delete', 'User',
            "User requested account deletion: {$user->email}" .
