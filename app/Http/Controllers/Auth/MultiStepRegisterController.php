...
{
    public static function generateSystemPassword(string $fullName): string
    {
        ...
        $letters = strtolower(preg_replace('/[^A-Za-z]/', '', $lastName) ?? '');
    ...
    public function register(Request $request)
    {
        ...
        return response()->json([
            'message'  => 'Account created. Check your email for your system-generated password. Pending administrator approval.',
