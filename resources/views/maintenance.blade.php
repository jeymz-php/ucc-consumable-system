...
<head>
    ...
    <title>UCC-CS | System Maintenance</title>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body {
            ...
            min-height: 100%; background: #0f3d22;
        ...
        .brand-box { background: #1a6b3a; color: #fff; font-size: 13px; font-weight: 700; padding: 6px 14px; border-radius: 8px; }
        ...
        .info-row { display: flex; gap: 8px; justify-content: center; margin-bottom: 1.5rem; flex-wrap: wrap; }
        .info-chip { background: #f4f6f5; border-radius: 8px; padding: 6px 14px; font-size: 12px; color: #555; display: flex; align-items: center; gap: 6px; }
...
<div class="card">
    <div class="brand">
        <div class="brand-box">UCC-CS</div>
        <span style="font-size:13px; color:#888;">Consumable Management System</span>
    </div>
    ...
    <p class="subtitle">
        We're currently performing maintenance on the UCC Consumable Management System.
    ...
    <div class="info-row">
        ...
        <div class="info-chip">
            ...
            <span id="downtime">Calculating...</span>
        </div>
    </div>
...
function updateDowntime() {
    ...
    const s = diff % 60;
    document.getElementById('downtime').textContent = `Down for ${h}h ${m}m ${s}s`;
}
setInterval(updateDowntime, 1000);
updateDowntime();
</script>
</body>
</html>