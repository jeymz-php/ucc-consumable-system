...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Alert banners */
        .alert-success { display: flex; align-items: flex-start; gap: 10px; background: #f0faf4; border: 1.5px solid #1a6b3a; border-radius: 10px; padding: 10px 14px; margin-bottom: 1.2rem; animation: slideDown 0.4s ease; }
        ...
        .alert-error { display: flex; align-items: flex-start; gap: 10px; background: #fff5f5; border: 1.5px solid #e24b4a; border-radius: 10px; padding: 10px 14px; margin-bottom: 1.2rem; animation: slideDown 0.4s ease; }
        .alert-error i { color: #e24b4a; font-size: 18px; }
        ...
        .form-footer { display: flex; align-items: center; justify-content: space-between; margin-bottom: 1.4rem; margin-top: 0.25rem; }
        .remember-wrap { display: flex; align-items: center; gap: 7px; font-size: 13px; color: #555; cursor: pointer; }
        .remember-wrap input { accent-color: #1a56db; cursor: pointer; }
        .forgot-link { font-size: 13px; color: #1a56db; font-weight: 600; text-decoration: none; }
        .forgot-link:hover { text-decoration: underline; }

        .btn-login { width: 100%; padding: 13px; background: #1a56db; color: #fff; border: none; border-radius: 8px; font-size: 14px; font-weight: 600; cursor: pointer; font-family: 'Inter', sans-serif; transition: background 0.2s; display: flex; align-items: center; justify-content: center; gap: 8px; }
        ...
        .register-link a { color: #1a56db; font-weight: 600; text-decoration: none; }
        .password-chip { display: inline-block; margin-top: 0.5rem; padding: 8px 10px; border-radius: 8px; background: #fff; color: #1a6b3a; border: 1px solid #cfe9d8; font-weight: 700; letter-spacing: 0.06em; font-size: 13px; word-break: break-all; }

        @media(max-width:640px) { body { padding: 0.75rem; } .card-wrap { flex-direction: column; } .left-panel { padding: 2rem 1.5rem; min-height: 180px; } .right-panel { padding: 1.5rem; } .form-footer { flex-direction: column; align-items: flex-start; gap: 0.6rem; } }
    </style>
</head>
<body>
    ...
    <div class="left-panel">
        <div class="ucc-logo">
            <img src="{{ asset('images/ucc.png') }}" alt="UCC Logo"
                 onerror="this.style.display='none'; this.parentElement.innerHTML='<span style=\'font-size:20px; font-weight:700; color:#1a56db;\'>UCC</span>'">
        </div>
